...
<div class="d-flex align-items-stretch">
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-4">
            <section class="py-3">
                <div class="container">
                {!! Form::open(['route' => 'study.store', 'data-parsley-validate'=> '', 'files'=> true]) !!}
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group {{ $errors->has('google') ? 'has-error' : ''}}">
                                        ...
                                        <small><a href="https://docs.google.com/forms" target="blank"><i class="fa fa-google" aria-hidden="true"></i> Go to Google Firms page</a></small>
                                ...
                                <div class="card-body">
                                    <p class="card-text">
                                        <div class="form-group">
                                            <input class="btn btn-success btn-block" type="submit" value="Publish Programme">
                                        </div>
                                    </p>
                                </div>
                            </div>
