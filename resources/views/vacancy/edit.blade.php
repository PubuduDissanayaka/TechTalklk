...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Edit "{{ $vacancy->title }}" Vacancy</div>
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['vacancy.update',$vacancy->id], 'data-parsley-validate'=> '', 'files'=> true]) !!}
                        {{Form::hidden('_method','PUT')}}
                            ...
                            <div class="form-group">
                                <input class="btn btn-success btn-block" type="submit" value="Edit Vacancy">
                            </div>
                            {!! Form::close() !!}
                    </div>
                </div>
