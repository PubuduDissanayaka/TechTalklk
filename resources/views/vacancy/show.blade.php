            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/vacancy/' . $vacancy->id . '/edit') }}" title="Edit Vacancy"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $vacancy->title }} </td></tr><tr><th> Details </th><td> {{ $vacancy->details }} </td></tr>
                                </tbody>
                            </table>
                        </div>
